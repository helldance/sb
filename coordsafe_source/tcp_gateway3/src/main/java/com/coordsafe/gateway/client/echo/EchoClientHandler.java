...
public class EchoClientHandler extends ChannelInboundHandlerAdapter {
    ...
    String gpsStart = "(013612345670BP01358490043598664080524A0117.5892N10346.6496E000.1101241323.8700000000L000450AB)";
    ...
    //String safeLinkAlarm =    "*HQ,7893267560,V1,160613,A,2230.7155,N,11355.1790,E,000.0,000,310813,FFFFFBFF#";
    String safeLinkAlarm = "*HQ,7893267560,V1,160613,A,2230.7155,N,11355.1790,E,000.0,000,310813,FFFFFFFD#"; 
    ...
    public EchoClientHandler(int firstMessageSize) throws Exception{
        ...
        if(firstMessageSize < 10)
        	...
        	gpsStart = "(013612345670BP01358490043598664080524A0117.5892N10346.6496E000.1101241323.8700000000L000450AB)";
	...
	public void sentGPSMessage(ChannelHandlerContext ctx){
    	...
    	for(int i = 0; i < 2; i++){
    		...
    		ctx.write(getMessage(safeLinkAlarm));
    		try {
				Thread.sleep(5000);
