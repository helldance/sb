...
public class TripController {
	...
	public String findTripDetailByTime(
		...
		List<TripDetail> tripDetails = tripService.findTripDetailBtwTimeFleetLink(Long.parseLong(locatorId), stm, etm);
	...
	@RequestMapping(value="{tripId}/map", method=RequestMethod.GET)
	public String getTripMap (@PathVariable("tripId") long tripId, Model model){
		TripDetail detail = tripService.findTripDetailById(tripId);
		
		model.addAttribute("tripDetail", detail);
