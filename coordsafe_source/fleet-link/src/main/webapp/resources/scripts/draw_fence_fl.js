...
function genImageUrl (){
    ...
    save_data = {"drawing_type":1,"geometry":geometry,"img_url":url}; 
}
...
function load(){
    ...
    $.getJSON("http://192.168.100.12:8070/geoready/api/zone/40?key=test-1234qwer",function(data){
...
function edit(){
    clearMap();
    //$.getJSON("/fleet-link/geofence/zone/40",function(data){
        //load_data=data.geometry;
        //if(load_data.type=="Polygon"){
