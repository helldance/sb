								...
								<div class="row-fluid">
									<div class="center">
										...
										<h1>
											...
											<span class="blue">Coord</span>
											<span class="black">Safe</span>
										</h1>
										<h4 class="blue">&copy; Company Name</h4>
									-->
									   <h1><img src="resources/img/logo.png"><span> Coord</span>Safe<span>.</span></h1>
													...
													<fieldset>
														<label>
															<span class="block input-icon input-icon-right">
																<input type="text" class="span12" placeholder="Username" name="j_username" value="<c:out value="${SPRING_SECURITY_LAST_USERNAME}" />" />
														...
														<div class="row-fluid">
															...
															<button type="submit" name="submit" value="Login"class="span4 btn btn-small btn-primary">
																<i class="icon-key"></i>
																Login
															</button>
														</div>
