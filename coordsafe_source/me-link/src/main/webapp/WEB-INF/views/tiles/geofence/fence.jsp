	...
	<div class="well">
		...
		<p class="pull-right">
			...
			<br>
						...
						class="btn btn-cancel no-border btn-small pull-right" onclick="cancelEditModal(this); return false;">
						<i class="icon-save"></i>&nbsp;Cancel
					</button>
			<c:choose>
				<c:when test="${action == 'edit'}">
				</c:when>
			...
			<c:when test="${action != 'edit'}">
				...
				<div class="controls" style="margin-top: 12px">
					<form id="zone" class="form-inline">
						...
						<label> <input type="radio" name="zone" value="safe"
							onclick="chooseZone()"> <span class="lbl"> Safe
								Zone</span>
						</label> <label> <input type="radio" name="zone" value="dangerous"
							onclick="chooseZone()"> <span class="lbl"> Danger
								Zone</span>
						</label>
