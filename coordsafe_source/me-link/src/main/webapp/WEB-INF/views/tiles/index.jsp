...
<head>
    ...
    <script>
        function markLocators(map1) {
            ...
            var req = "/me-link/guardian/id/" + ${guardian.id};
...
<body>
	...
	<script>
	    ...
	    function queryHistory(loc){
	        ...
	        console.log("loc=" + loc);
	        var req = "/me-link/trip/detail/" + loc + "/" + stime + "," + etime;
	    ...
	    function createNumberMarker (point, number){             
	        var number_icon = "/me-link/resources/numbered_marker/number_" + number + ".png";
