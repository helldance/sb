		...
		submitHandler : function(form) {
			...
			$.ajax({
				...
				success: function() {
					...
					//$('#contentCoordsafe').load("/safe-link/locator/search");
...
<div class="widget-body">
	...
	action="/safe-link/locator/${action}" class="form-horizontal"
	...
	<p class="muted">* denotes compulsory fields.</p>
				...
				<div class="widget-toolbox  padding-8 clearfix">
					<div class="pull-left">
						<input class="btn  btn-primary no-border" type="button" value="Back" onclick="cancelEditModal(this);"/> 
