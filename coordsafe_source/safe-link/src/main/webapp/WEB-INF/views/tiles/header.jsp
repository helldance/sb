...
<script src="/safe-link/resources/scripts/modernizr.js"></script>
						...
						<div class="container-fluid">
							<ul class="nav ace-nav pull-right">
								<sec:authorize access="hasRole('ROLE_ADMIN')">
									<li><a href="/safe-link/guardian/search" id="guardians_link"
										onclick="loadPrimaryModal(this); return false;"> <i
											class="icon-eye-open  icon-only"></i> Guardians
									</a></li>
									
									<li><a href="/safe-link/locator/search" id="locators_link"
										onclick="loadPrimaryModal(this); return false;"> <i
								...
								<sec:authorize access="hasAnyRole('ROLE_SERVICE','ROLE_ADMIN')">
									<li><a
										href="/safe-link/retailer/search?retailer=<sec:authentication property="principal.username"/>"
								...
								<sec:authorize access="hasAnyRole('ROLE_USER','ROLE_ADMIN')">
									<li><a
										href="/safe-link/wards/search?guardian=<sec:authentication property="principal.username"/>"
